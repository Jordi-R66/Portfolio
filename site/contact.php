	...
	<main>
		<div id="info-contact-box">
			...
			<li class="contact-links">
				...
				<a class="liens-contact" href="mailto:jordi.rocafort@etu.umontpellier.fr"><img class="socials-icon" src="img/email.png" alt="E-Mail">jordi.rocafort@etu.umontpellier.fr</a>
			</li>
		</div>
	</main>
